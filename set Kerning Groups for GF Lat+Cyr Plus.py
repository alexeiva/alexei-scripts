...
### Cyrillic
	...
	"Ia-cy" : ["Ia-cy", "H"],
	"Dje-cy" : ["T", "Tshe-cy"],
	"Yat-cy" : ["H", "Softsign-cy"],
	"Yusbig-cy" : ["X", "X"],
	"Fita-cy" : ["O", "O"],
	"Izhitsa-cy" : ["V", "V"],
	"Ghestroke-cy" : ["H", "Ge-cy"],
	"Ghemiddlehook-cy" : ["H", "Tshe-cy"],
	"Zhedescender-cy" : ["X", "Kadescender-cy"],
	"Zedescender-cy" : ["Ze-cy", "B"],
	"Kadescender-cy" : ["H", "Kadescender-cy"],
	"Kaverticalstroke-cy" : ["H", "K"],
	"Kastroke-cy" : ["H", "K"],
	"Kabashkir-cy" : ["T", "K"],
	"Endescender-cy" : ["H", "Tse-cy"],
	"Pemiddlehook-cy" : ["H", "Tshe-cy"],
	"Pedescender-cy" : ["H", "Tse-cy"],
	"Haabkhasian-cy" : ["O", "O"],
	"Esdescender-cy" : ["O", "C"],
	"Tedescender-cy" : ["T", "T"],
	"Ustrait-cy" : ["Y", "Y"],
	...
	"Chedieresis-cy" : ["Che-cy", "H"],
	"Gedescender-cy" : ["H", "Ge-cy"],
	"Yerudieresis-cy" : ["H", "H"],
	"Qa-cy" : ["O", "O"],
	"We-cy" : ["V", "V"],
	"Ef-cy.loclBGR" : ["O", "O"],
	"Ghestroke-cy.loclBSH" : ["H", "F"],
	"Zedescender-cy.loclBSH" : ["Ze-cy", "B"],
	"Esdescender-cy.loclBSH" : ["O", "C"],
	"Esdescender-cy.loclCHU" : ["O", "C"],
	"De-cy.loclBGR" : ["De-cy", "Tse-cy"],
	"Ii-cy.loclBGR" : ["H", "H"],
	"Iishort-cy.loclBGR" : ["H", "H"],
	"Iigrave-cy.loclBGR" : ["H", "H"],
	"El-cy.loclBGR" : ["El-cy", "H"],
	"a-cy" : ["a", "n"],
	"be-cy" : ["be-cy", "o"],
	"ve-cy" : ["n", "ve-cy"],
	"ge-cy" : ["n", "ge-cy"],
